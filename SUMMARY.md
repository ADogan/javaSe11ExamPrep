 ...
 * 1\. Understanding Java Technology and environment
   ...
   * [Resources](en/1_understanding_java_technology_and_environment/resources.md)
 * 2\. Working With Java Primitive Data Types and String APIs
   ...
   * [Resources](en/2_working_with_java_primitive_data_types_and_string_apis/resources.md)
 * 3\. Working with Java Arrays
   ...
   * [Resources](en/3_working_with_java_arrays/resources.md)
 * 4\. Creating and Using Methods
   ...
   * [Resources](en/4_creating_and_using_methods/resources.md)
 * 5\. Reusing Implementations Through Inheritance
   ...
   * [Resources](en/5_reusing_implementations_through_inheritance/resources.md)
 * 6\. Handling Exceptions
   ...
   * [Resources](en/6_handling_exceptions/resources.md)
 * 7\. Creating a Simple Java Program
   ...
   * [Resources](en/7_creating_a_simple_java_program/resources.md)
 * 8\. Using Operators and Decision Constructs
   ...
   * [Resources](en/8_using_operators_and_decision_constructs/resources.md)
 * 9\. Describing Objects and Classes
   ...
   * [Resources](en/9_describing_objects_and_classes/resources.md)
 * 10\. Applying Encapsulation
   ...
   * [Resources](en/10_applying_encapsulation/resources.md)
 * 11\. Programming Abstractly Through Interfaces
   ...
   * [Resources](en/11_programming_abstractly_through_interfaces/resources.md)
 * 12\. Understanding Modules
   ...
   * [Resources](en/12_understanding_modules/resources.md)
 ...
 * 13\. Java Fundamentals
   ...
   * [Resources](en/13_java_fundamentals/resources.md)
 * 14\. Java Interfaces
   ...
   * [Resources](en/14_java_interfaces/resources.md)
 * 15\. Functional Interface and Lambda Expressions
   ...
   * [Resources](en/15_functional_interface_and_lambda_expressions/resources.md)
 * 16\. Built-in Functional Interfaces
   ...
   * [Resources](en/16_built-in_functional_interfaces/resources.md)
 * 17\. Migration to a Modular Application
   ...
   * [Resources](en/17_migration_to_a_modular_application/resources.md)
 * 18\. Concurrency
   ...
   * [Resources](en/18_concurrency/resources.md)
 * 19\. Use I/O Streams to read and write files
   ...
   * [Resources](en/19_use_i_o_streams_to_read_and_write_files/resources.md)
 * 20\. Database Applications with JDBC
   ...
   * [Resources](en/20_database_applications_with_jdbc/resources.md)
 * 21\. Annotations
   ...
   * [Resources](en/21_annotations/resources.md)
 * 22\. Exception Handling and Assertions
   ...
   * [Resources](en/22_exception_handling_and_assertions/resources.md)
 * 23\. Generics and Collections
   ...
   * [Resources](en/23_generics_and_collections/resources.md)
 * 24\. Java Stream API
   ...
   * [Resources](en/24_java_stream_api/resources.md)
 * 25\. Lambda Operations on Streams
   ...
   * [Resources](en/25_lambda_operations_on_streams/resources.md)
 * 26\. Services in a Modular Application
   ...
   * [Resources](en/26_services_in_a_modular_application/resources.md)
 * 27\. Parallel Streams
   ...
   * [Resources](en/27_parallel_streams/resources.md)
 * 28\. Secure Coding in Java SE Application
   ...
   * [Resources](en/28_secure_coding_in_java_se_application/resources.md)
 * 29\. Localization
   ...
   * [Resources](en/29_localization/resources.md)
